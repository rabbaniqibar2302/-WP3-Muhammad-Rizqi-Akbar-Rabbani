                            ...
                            <div class="caption">
                                ...
                                <p><?php
                                    if (
                                        ...
                                        echo
                                        "<i class='btn btn-outline primary fas fw fa-shopping-cart'>Booking&nbsp;&nbsp0</i>";
                                    } else {
                                        echo
                                        "<a class='btn btn-outlineprimary fas fw fa-shoppingcart'href='" . base_url('booking/tambahBooking/' . $buku->id) . "'> Booking</a>";
                                    } ?>
